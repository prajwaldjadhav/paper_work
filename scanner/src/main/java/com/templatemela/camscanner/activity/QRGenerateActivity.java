...
import com.templatemela.camscanner.qrcode_generate.Contents;
import com.templatemela.camscanner.qrcode_generate.Intents;
import com.templatemela.camscanner.qrcode_generate.QRCodeEncoder;
        ...
        if (id == R.id.iv_back) {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    uri = FileProvider.getUriForFile(this, "com.pdf.dudepdftools", file);
                } else {
