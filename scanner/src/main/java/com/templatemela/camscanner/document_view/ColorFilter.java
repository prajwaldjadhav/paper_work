...
public class ColorFilter {
    ...
    //renderscript
    //renderscript is a framework for running computationally intensive task at high performance on Android
    //data parallel computation
    //renderscript runtime parallelizes work across processor available on a device, such as multi core CPU and GPU.4
    //renderscript is usefull in application performing image processing, computational photography and computer vision

    //Allocation
    //this class provides the primary method through which data is passed to and from renderscript kernal
    public Bitmap filter1(Context context, Bitmap bitmap) {
        ...
        //create a allocation for bitmap in kernal
        this.inputAllocation = Allocation.createFromBitmap(this.renderScript, bitmap);
        //create a allocation with the size specified by the type and no mipmaps generated by default
        ...
        //intrinsic for applying a color matrix for allocations.
