package com.templatemela.camscanner.db;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    //create a table to store a meta data of all the folder
    @Override
    ...
    //create a table to store a all the images of given folder
    ...
    //move image to the given folder
    ...
    //get all the images of given folder
    ...
    //get all the doc from the given folder name
    ...
    //from given folder find a image with given name
    ...
    //delete a folder from alldoc table and remove the corresponding folder table
    ...
    //delete a image from the given folder
    ...
    //rename the folder in alldoc table and rename the corresponding table
    ...
    //update the first image of the folder
    ...
    //update the image for given name of some folder
    ...
    //rename the image in given folder
