...
import pdf.dudepdftools.activity.MainActivity2;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int i) {
        ...
        viewHolder.rl_group.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((MainActivity2) activity).clickOnListItem(((DBModel) arrayList.get(i)).getGroup_name());
            }
        });
        ...
        viewHolder.iv_group_more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((MainActivity2) activity).clickOnListMore(arrayList.get(i),((DBModel) arrayList.get(i)).getGroup_name(), ((DBModel) arrayList.get(i)).getGroup_date());
            }
        });
    }
